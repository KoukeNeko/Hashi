...
const Sidebar: React.FC<SidebarProps> = ({ currentTab, onTabChange, isOpen, onClose, onLogout, user }) => {
  
  const navGroups = [
    {
      label: 'General',
      items: [
        { id: TabView.DASHBOARD, label: 'Overview', icon: LayoutDashboard },
      ]
    },
    {
      label: 'Application',
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 text-xs text-center text-zinc-600 font-mono">
          v3.1.0-hashi
        </div>
      </aside>
    </>
