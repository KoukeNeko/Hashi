    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <PageHeader
                ...
                description={
                    dockerNotInstalled
                        ? 'Docker is not installed or configured on this server.'
                            ...
                            <div>
                                ...
                                <div className="divide-y divide-border">
                                    {containers.map((container) => (
                                        <div
                                            key={container.id}
                                            className="grid grid-cols-2 lg:grid-cols-12 gap-3 lg:gap-4 p-4 hover:bg-zinc-800/50 transition-colors items-center group"
                                        >
                                            {/* Mobile Row 1: State & Actions */}
                                            <div className="col-span-1 lg:col-span-1 order-1 flex items-center">
                                                <span
                                                    className={`px-2 py-1 rounded border text-xs font-mono font-bold ${getStateColor(container.state)}`}
                                                >
                                                    {container.state}
                                                </span>
                                            </div>
                                            ...
                                            <div className="col-span-2 lg:col-span-3 lg:order-3 order-4">
                                                <span className="lg:hidden text-zinc-500 text-[10px] uppercase mr-2">
                                                    Image:
                                                </span>
                                            ...
                                            <div className="col-span-1 lg:col-span-2 lg:order-4 order-5">
                                                <div className="text-zinc-500 text-[10px] uppercase lg:hidden mb-1">
                                                    Ports
                                                </div>
                                    ...
                                    {images.map((img) => (
                                        ...
                                        >
                                            <div className="col-span-2 lg:col-span-2 lg:order-1 order-3">
                                                <div className="lg:hidden text-zinc-500 text-[10px] uppercase mb-0.5">
                                                    ID
                                                </div>
                                                <div
                                    ...
                                    {networks.map((net) => (
                                        ...
                                        >
                                            <div className="col-span-2 lg:col-span-3">
                                                ...
                                                <div className="lg:hidden text-zinc-500 text-xs font-mono">
                                                    {net.id}
                                                </div>
                                            </div>

                                            <div className="col-span-1 lg:col-span-2">
                                                <div className="lg:hidden text-zinc-500 text-[10px] uppercase">
                                                    Driver
                                                </div>
