                ...
                actions={
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className={`px-4 py-2 rounded font-medium text-sm transition-colors border shadow-lg ${enabled
                    ...
                    <tbody className="text-sm divide-y divide-border">
                        {MOCK_FIREWALL_RULES.map(rule => (
                            <tr key={rule.id} className={`hover:bg-zinc-800/50 transition-colors ${!enabled ? 'opacity-50' : ''}`}>
                                ...
                                <td className="p-4">
                                    <span className={`px-2 py-0.5 rounded text-xs font-bold ${rule.action === 'ALLOW'
