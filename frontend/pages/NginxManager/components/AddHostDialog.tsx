...
const AddHostDialog: React.FC<AddHostDialogProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage =
                err instanceof Error ? err.message : 'Failed to create virtual host';
                ...
                <DialogBody>
                    ...
                    <div className="space-y-4 pt-4 border-t border-zinc-800">
                        ...
                        <label className="flex items-center justify-between cursor-pointer">
                            ...
                            >
                                <div
                                    className={`w-4 h-4 bg-white rounded-full transition-transform mx-1 ${gzip ? 'translate-x-5' : 'translate-x-0'}`}
                                />
                            </button>
                        </label>
                        ...
                        <label className="flex items-center justify-between cursor-pointer">
                            ...
                            >
                                <div
                                    className={`w-4 h-4 bg-white rounded-full transition-transform mx-1 ${rateLimit ? 'translate-x-5' : 'translate-x-0'}`}
                                />
                            </button>
                        </label>
                        ...
                        {rateLimit && (
                            <div className="ml-4">
                                <FormInput
                                    ...
                                    onChange={(v) =>
                                        setRateLimitRate(parseInt(v) || DEFAULT_RATE_LIMIT)
                                    }
                                    className="w-32"
                                />
                            </div>
