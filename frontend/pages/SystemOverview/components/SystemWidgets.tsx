...
// ==================== OS Icon ====================
export const OsIcon = ({ osName, className = "text-emerald-500", size = 32 }: { osName?: string, className?: string, size?: number }) => {
    const name = (osName || '').toLowerCase();

    // Ubuntu
    if (name.includes('ubuntu')) {
        return (
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={size} height={size} className={className} fill="currentColor">
                <title>Ubuntu</title>
