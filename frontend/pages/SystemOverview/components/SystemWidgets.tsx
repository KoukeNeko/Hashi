...
import { ChevronRight, LucideIcon, Server, HelpCircle } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4">
            ...
            <div className="mt-2 text-center">
                ...
                <p className="text-zinc-500 text-xs mt-1 font-medium uppercase tracking-wide">
                    {subLabel}
                </p>
            </div>
        </div>
...
export const QuickStat = ({
    ...
    <div className="flex-1 bg-surface border border-border p-5 rounded-lg flex justify-between items-center group hover:border-zinc-600 transition-colors cursor-pointer">
        ...
        <div
            className={`p-3 rounded-lg ${colorClass} bg-opacity-10 group-hover:bg-opacity-20 transition-all`}
        >
            <Icon size={24} strokeWidth={2} />
        </div>
        <ChevronRight
            className="text-zinc-700 group-hover:text-zinc-400 transition-colors absolute top-5 right-5"
            size={16}
        />
    </div>
);
...
export const SoftwareCard = ({
    ...
    <div className="bg-zinc-900 border border-border p-4 rounded-lg flex flex-col items-center justify-center gap-3 relative group hover:border-zinc-700 transition-all">
        ...
        <div className="flex items-center gap-1.5 mt-2 bg-zinc-950 px-2 py-1 rounded-full border border-zinc-800">
            <div
                className={`w-1.5 h-1.5 rounded-full ${status ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-rose-500'}`}
            ></div>
            <span
                className={`text-[10px] font-bold uppercase tracking-wide ${status ? 'text-emerald-500' : 'text-rose-500'}`}
            >
...
export const OsIcon = ({
    ...
    if (name.includes('windows')) {
        return (
            ...
            >
                <title>Windows</title>
                <path d="M0 3.449L9.75 2.134v9.426l-9.75.14zm10.949 9.682l13.051.186v-1.78L10.949 3.033zm-10.949.497L9.75 14.07v8.947l-9.75-1.328zm10.949.19v10.643l13.051-1.83V14.16z" />
            </svg>
        );
    }

    // Generic Linux (for anything else with 'linux' in it)
