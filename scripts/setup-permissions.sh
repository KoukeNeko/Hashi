...
# ==================== Storage Pool (RAID/ZFS) ====================
$HASHI_USER ALL=(ALL) NOPASSWD: /usr/sbin/mdadm
$HASHI_USER ALL=(ALL) NOPASSWD: /usr/sbin/smartctl
$HASHI_USER ALL=(ALL) NOPASSWD: /usr/bin/smartctl
EOF
